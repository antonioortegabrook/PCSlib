...
/** Return the index in table of a PCS from its name
	@ params: cardinal number (int), ordinal number (int)
	@ returns: index (int)
 */
int name_table_index(int ncar, int nord);

/** Return the index in table of a PCS from its binary value and
		cardinal number
...
/** Return the index in table of a PCS's Z mate from its index (0 if it
	doesn't exists)
...
/** Return the index in table of the complement of a PCS from its index
	@ params: index of PCS n (int)
...
/** Return the cardinal number of a PCS from its index
	@ params: index of PCS n (int)
	@ returns: n's cardinal number (int)
 */
int ncar_table(int index);

/** Return the ordinal number of a PCS from its index
	@ params: index of PCS n (int)
	@ returns: n's ordinal number (int)
 */
int nord_table(int index);

/** Write to a given array the prime form of a PCS from its index
